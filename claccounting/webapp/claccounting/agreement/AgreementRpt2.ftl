...
<div id="params_birtReport" style='display:none'>
    <#-- <INPUT type="HIDDEN" name="agreementId" value="${agreement.agreementId}"/>  funciona y tambien el de abajo -->
        <INPUT type="HIDDEN" name="agreementId" value="${requestParameters.agreementId}"/>
</div>
...
<script type="text/javascript">
    ...
    formObj.action = "/birt/preview?__page=2&__report=component://birt/webapp/accounting/reports/ContratoVenta3.rptdesign&__masterpage=true&__format=html";
